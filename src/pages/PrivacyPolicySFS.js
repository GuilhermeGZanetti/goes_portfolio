...
const PolicyPage = () => {
  return (
    <div style={{ margin: 40 }}>
      <head>
        <title>Privacy Policy Sphere Road Saga</title>
        </head>
        <body>
        <h1>Privacy Policy Sphere Road Saga</h1>
        <br/>
        <div>
            <b>Privacy Policy</b><br/><br/>

        Guilherme Goes Zanetti built the Sphere Road Saga app as an Ad Supported app. This SERVICE is provided by Guilherme Goes Zanetti at no cost and is intended for use as is.
        <br/>
        ...
        <a href="google.com/policies/privacy/">Google Play Services</a> <br/>
        <a href="unity3d.com/legal/privacy-policy">Unity</a><br/>
        ...
        <b>Contact Us</b>
        <br/>
        If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact me at guigoes8@hotmail.com.
        </div>
        </body>
    </div>
  );
